...
def get_app_files():
    ...
    app_info = {
        ...
        "more_html": url_to_android_html(
            """<span style="color: red;">提示: 部分网站可能需要VPN翻墙后访问，大量收购草榴/98堂/91邀请码，或者相互交换。可邮件联系合作：1024huijia@gmail.com</span>"""),
...
def get_iphone_files():
    ...
    iphone_home = {
        ...
        # 其中的内容是消息提醒内容
        "content": url_to_iphone("""<span>提示: 部分网站可能需要VPN翻墙后访问，大量收购草榴/98堂/91邀请码，或者相互交换，可邮件联系合作：1024huijia@gmail.com</span>""", True)
    }
    return iphone_home
